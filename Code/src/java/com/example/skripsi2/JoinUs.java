...
public class JoinUs extends AppCompatActivity {
    ...
    EditText tempatlahir,tanggallahir,userjeniskelamin,usergolongandarah,usersukuasalmarga,userdesa,userkecamatan,userkabupaten,
    userpropinsi,userkodepos,usernohp,userstatus,useragama,userasalsma,asdesa,askecamatan,askabupaten,aspropinsi,askodepos,email,fatnama,
    fatdesa,fatkecamatan,fatkabupaten,fatpropinsi,fatkodepos,fatnohp,fatemail,fatpendidikan,fatagama,ibunama,
    ibudesa,ibukecamatan,ibukabupaten,ibupropinsi,ibukodepos,ibunohp,ibuemail,ibupendidikan,ibuagama,wlnama,
    wldesa,wlkecamatan,wlkabupaten,wlpropinsi,wlkodepos,wlnohp,wlemail,wlpendidikan,wlagama;
    Button update,nex;
    private static final String UPDATE_URL = "http://192.168.1.11/regist_and_login/kirim.php";
